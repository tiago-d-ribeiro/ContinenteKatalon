...
WebUI.setText(findTestObject('Site Continente/PaginaInicial/input_Pesquisar'), 'Cereais')

WebUI.click(findTestObject('Site Continente/PaginaInicial/lupa_pesquisar'))
