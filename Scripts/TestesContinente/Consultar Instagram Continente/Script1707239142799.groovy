...
WebUI.navigateToUrl('https://www.instagram.com/continente/')

WebUI.click(findTestObject('Object Repository/Page_Continente (continente)  Instagram pho_8704dc/button_Decline optional cookies'))
